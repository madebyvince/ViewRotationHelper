...
![View Rotation Helper Logo](logo.png)

A Blender add-on that provides quick access to orthogonal views with rotation control directly from the sidebar.

![Blender Version](https://img.shields.io/badge/Blender-3.0%2B-orange)
![License](https://img.shields.io/badge/license-MIT-blue)
[![Download Latest Release](https://img.shields.io/github/v/release/madebyvince/ViewRotationHelper?label=Download%20Latest%20Release)](https://github.com/madebyvince/ViewRotationHelper/releases/latest)
...
1. Download the `view_rotation_helper.py` file
2. Open Blender and go to `Edit` → `Preferences` → `Add-ons`
3. Click `Install...` at the top
4. Select the downloaded `view_rotation_helper.py` file
5. Enable the add-on by checking the checkbox next to "3D View: View Rotation Helper"
...
If you find this add-on useful, consider:
